    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-5xl font-bold text-primary-500 mb-1">{userCoins}</p>
          <p className="text-xs text-gray-400">≈ {(userCoins * 100).toLocaleString()}원</p>
        </div>
